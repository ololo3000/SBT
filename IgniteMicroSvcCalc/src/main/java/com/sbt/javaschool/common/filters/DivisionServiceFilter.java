...
public class DivisionServiceFilter implements IgnitePredicate<ClusterNode> {
    ...
    public boolean apply(ClusterNode clusterNode) {
        ...
        Boolean divisionSvcNode = clusterNode.attribute("division.service.node");
        ...
        CalculatorSvcMetric metric = cache.get(DivisionService.SERVICE_NAME);
        ...
        for (String svcName : Arrays.asList(
                DivisionService.SERVICE_NAME,
